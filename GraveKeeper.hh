...
public:
  ...
  GraveKeeper(psyqo::Vec2 position, eastl::array<eastl::string_view, 2> pre_message_, eastl::array<eastl::string_view, 2> post_message_) : Character(position), pre_message(pre_message_), post_message(post_message_) {
