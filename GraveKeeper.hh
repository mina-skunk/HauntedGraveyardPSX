...
public:
  ...
  HauntedGraveyard::graphics::Sprite top_sprite = {{.x = 0.0_fp, .y = 0.0_fp}, {.col = 8, .row = 1}, 3}; // TODO
  HauntedGraveyard::graphics::Sprite bottom_sprite = {{.x = 0.0_fp, .y = 0.0_fp}, {.col = 8, .row = 1}, 4}; // TODO
